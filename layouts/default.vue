    ...
    <div :class="[
      ...
      <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200">
        <div class="flex items-center space-x-3">
          ...
          <!-- <h1 :class="[
            'font-semibold text-gray-800 transition-opacity duration-200',
    ...
    <div :class="[
      ...
      <header class="bg-white shadow-sm border-b border-gray-200 h-16 flex items-center justify-between px-4">
        <div class="flex items-center space-x-4">
          ...
          <!-- <button @click="toggleSidebar"
            class="p-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors duration-150 cursor-pointer">
            <svg class="w-5 h-5 cursor-pointer" fill="currentColor" viewBox="0 0 20 20">
      ...
      <main class="flex-1 p-6 overflow-auto">
        <div class="mx-auto">
          ...
          <!-- Form Card -->
          <!-- <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-6">User Information Form</h2>
            ...
            <form class="space-y-6">
              <div>
                ...
                <input id="email" type="email" required
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-150"
              ...
              <div class="pt-4">
                <button type="submit"
                  class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-150 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                  Submit
                </button>
              </div>
            </form>
          ...
          <!-- <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 class="font-semibold text-gray-900 mb-2">Active Sessions</h3>
              <p class="text-3xl font-bold text-green-600">892</p>
              <p class="text-sm text-gray-600 mt-1">+5% from last week</p>
            </div>

            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 class="font-semibold text-gray-900 mb-2">Revenue</h3>
